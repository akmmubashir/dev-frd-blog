...
const Search = () => {
  return (
    <div className="flex items-center max-md:flex-col max-md:items-end gap-[20px]">
      <div className="bg-[#EEEEEE] rounded-[30px] p-[16px_0_16px_20px] max-md:p-[10px_0_10px_12px] min-w-[400px] max-md:min-w-full flex items-center gap-[10px]">
        ...
        <input
          ...
          className="bg-transparent outline-none placeholder:text-black text-[18px] max-md:text-[16px] w-full"
        />
      </div>
